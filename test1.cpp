...
void csr_matrix_vector_transpose(); // TODO
...
TEST(SparseMatrixTest, MatrixVectorProduct) { 
    ...
    csr_matrix_vector_product(A, IA, JA, n, x, b);

#ifdef VERBOSE
    print_vector("result", b, n);
#endif
...
TEST(SparseMatrixTest, MatrixTranspose) { 
    ...
    int Mt[m*n];
    // TODO: compute w/ dense method for comparison
    matrix_transpose(M, Mt, m, n);

    int Mtt[m*n] = {0};
    // TODO: (1) fold into csr_transpose
    for (int i=0; i<n; ++i) {  
    ...
    // TODO: (1) modify csr_transpose to output in csr storage
